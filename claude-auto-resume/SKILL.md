...
description: >
  ...
  Auto-suspends if 5h quota ≥90% or 7d quota ≥97%, schedules cron wake for auto-resume after reset.
metadata:
  {
    "openclaw":
      {
...
| 7d | ≥ 97% | `anthropic-ratelimit-unified-7d-utilization` |
...
Trigger: `5h_util >= 0.90` OR `7d_util >= 0.97`.
